...
// Remove the juice 
generate awayprobopen = 1/((1 + 100) /abs(awayspreadopenodds)) if awayspreadopenodds < 0
replace awayprobopen = 1/(awayspreadodds/(100+1)) if awayspreadodds > 0
...
save NBAFavReturnsData, replace